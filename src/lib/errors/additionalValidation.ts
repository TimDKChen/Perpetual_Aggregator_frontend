...
import { BaseContract, type Overrides, type Provider, type TransactionRequest } from "ethers";
...
// ****************
import { type ErrorPattern } from "@gmx-io/sdk/utils/errors/transactionsErrors";
import { type mustNeverExist } from "@gmx-io/sdk/utils/types";
