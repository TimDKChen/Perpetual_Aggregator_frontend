...
// import { SignedTokenPermit } from "domain/tokens"; can find
import { abis } from "@gmx-io/sdk/abis/index";

import { type ErrorData, type ErrorLike, extendError, parseError } from ".";
...
export function getIsNonEoaAccountError(error: ErrorLike) {
